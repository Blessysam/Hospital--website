...
<body>
    ...
    <section class="doctors" id="doctors">
        ...
        <div class="doc-content" data-aos="fade-right" data-aos-duration='800'>
                ...
                <a href="Psy_doc.html"><p><i class='bx bx-chevrons-right'></i></p></a>
            </div>
            <div class="doc-content" data-aos="fade-right" data-aos-duration='800'>
                ...
                <a href="Onc_doc.html"><p><i class='bx bx-chevrons-right'></i></p></a>
            </div>
            <div class="doc-content" data-aos="fade-left" data-aos-duration='800'>
                ...
                <a href="Car_doc.html"><p><i class='bx bx-chevrons-right'></i></p></a>
            </div>
            <div class="doc-content" data-aos="fade-left" data-aos-duration='800'>
                ...
                <a href="Orth_doc.html"><p><i class='bx bx-chevrons-right'></i></p></a>
            </div>
        </div>
    </section>
    ...
    <section class="services" id="services">
        ...
        <div class="service-container">
            <div class="service-content" data-aos="zoom-in" data-aos-duration='800'>
                <a href="Orthopedics.html"><img src="Images/icon-1.png">
                <span>Orthopedics</span></a>
            </div>
            <div class="service-content" data-aos="zoom-in" data-aos-duration='800'>
                <a href="Oncology.html"><img src="Images/icon-2.png">
                <span>Oncology</span></a>
            </div>
            <div class="service-content" data-aos="zoom-in" data-aos-duration='800'>
                <a href="Psychiatry.html"><img src="Images/icon-3.png">
                <span>Psychiatry</span></a>
            </div>
            <div class="service-content" data-aos="zoom-in" data-aos-duration='800'>
                <a href="Cardiology.html"><img src="Images/icon-4.png">
                <span>Cardiology</span></a>
            </div>
            <div class="service-content" data-aos="zoom-in" data-aos-duration='800'>
                <a href="Pediatrics.html"><img src="Images/icon-5.png">
                <span>Pediatrics</span></a>
            </div>
            <div class="service-content" data-aos="zoom-in" data-aos-duration='800'>
                <a href="Osteology.html"><img src="Images/icon-6.png">
                <span>Osteology</span></a>
            </div>
        </div>
    </section>
    <section class="blog" id="blog">
        ...
        <div class="blog-container">
            <div class="blog-content" data-aos="fade-up" data-aos-duration='1500'>
                ...
                <a href="blog_1.html"><button type="button" class="btn"> Read More</button></a>
            </div>
            <div class="blog-content" data-aos="fade-down" data-aos-duration='1500'>
                ...
                <a href="blog_2.html"><button type="button" class="btn"> Read More</button></a>
            </div>
            <div class="blog-content" data-aos="fade-up" data-aos-duration='1500'>
                <a href="#"><i class='bx bx-user'> BY SPECIALIST</i></a> 
                ...
                <a href="blog_3.html"><button type="button" class="btn"> Read More</button></a>
            </div>
        </div>
    </section>
